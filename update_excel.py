...
ESP32_URL = "http://192.168.1.7/data"

# Path to your Excel file
file_path = r"D:\STEM Projects\STEM Tilt\sensor_data.xlsx"  # Update this with the desired file path
...
def initialize_excel():
    try:
        ...
        if "Sensor Data" not in workbook.sheetnames:
            ...
            headers = ["Timestamp", "Temperature (°C)", "Humidity (%)", "Pitch (°)", "Roll (°)", "Vibration"]
...
def append_to_excel(data):
    try:
        ...
        new_row = [
            ...
            data.get("pitch", "N/A"),
            data.get("roll", "N/A"),
            "Detected" if data.get("vibration", False) else "No Vibration"
        ]
